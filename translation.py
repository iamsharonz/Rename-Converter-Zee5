...
"""
    ...
    NOT_AUTH_USER_TEXT = "CONTACT @MrNobody_Here "
    NOT_AUTH_USER_TEXT_FILE_SIZE = "IF You Got This Message You Should Contact @MrNobody_Here "
